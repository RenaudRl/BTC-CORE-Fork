...
public class DatasourcesConfig {
    ...
    public static class MysqlConfig {
        ...
        @Setting("sqlUrl")
        private String sqlUrl = "jdbc:mysql://{host}:{port}/{database}?useSSL={usessl}";
        ...
        public void setSqlUrl(String sqlUrl) { this.sqlUrl = sqlUrl; }
    }
    ...
    public static class RedisConfig {
        ...
        /**
         * Backend type: redis, dragonfly, or valkey.
         * All three are Redis-protocol compatible.
         * - redis: Standard Redis server
         * - dragonfly: DragonFlyDB (multi-threaded Redis alternative)
         * - valkey: Valkey (open-source Redis fork by Linux Foundation)
         */
        @Setting("backend-type")
        private String backendType = "redis";
    ...
    public static class APIConfig {
        ...
        public boolean isEnabled() { return enabled; }
        public boolean isIgnoreSslCertificate() { return ignoreSslCertificate; }
        public String getUsername() { return username; }
    ...
    public PostgresConfig getPostgresConfig() { return postgresConfig; }
    public MongoDBConfig getMongoDbConfig() { return mongoDbConfig; }
