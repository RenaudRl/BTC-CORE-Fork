...
tasks.jar {
    manifest {
        ...
        attributes(
            ...
            // Le brand est ce que `/version` affiche et ce que ServerBuildInfo.brandName() rend.
            // Il ne sert qu'a l'identification : aucune API, aucun comportement n'en depend.
            "Brand-Id" to "borntocraft:btc-core",
            "Brand-Name" to "BTC-CORE",
